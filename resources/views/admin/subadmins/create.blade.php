    ...
    <div class="max-w-[800px] mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-gray-100 bg-gray-50/50">
                <h3 class="font-extrabold text-xl text-[#081828] mb-1">Add New Sub-Admin</h3>
                <p class="text-gray-500 text-xs">Buat akun staf operasional baru dengan hak akses terbatas (Sub-Admin).</p>
            </div>
            ...
            <form action="{{ route('admin.save-subadmin') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1.5">
                        <label for="password" class="block text-xs font-bold text-[#081828] uppercase tracking-wider">Password Akun</label>
                    ...
                    <div class="space-y-1.5 sm:col-span-2">
                        <label for="image" class="block text-xs font-bold text-[#081828] uppercase tracking-wider">Foto Profil (Opsional)</label>
                        <div class="flex items-center gap-4 p-4 border border-dashed border-gray-200 rounded-xl bg-gray-50/50">
                            <div class="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center border border-gray-200 text-gray-400 shrink-0 overflow-hidden">
